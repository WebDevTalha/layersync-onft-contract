...
//
task("mintPrice", "mintPrice get the Mint Price", require("./mintPrice"))
    .addParam("contract", "Name of contract")

//
task("setPrice", "setPrice() Set ONFT Mint Price", require("./setPrice"))
    .addParam("contract", "Name of contract")
    .addParam("price", "the price of ONFT")
